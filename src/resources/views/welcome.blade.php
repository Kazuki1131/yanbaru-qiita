            ...
            <div class="my-4">
                <div class="card mx-auto w-100">
                    ...
                    <div class="card-body h5">
                        ...
                        <dl class="row mb-4">
                            <dt class="col-md-4 text-right">投稿日時</dt>
                            <dd class="col-md-8">{{ NOW() }}</dd>
                        </dl>
        ...
        <div class="col-md-6">
            <div class="my-4">
                <div class="card mx-auto w-100">
                    ...
                    <div class="card-body h5">
                        <dl class="row mb-4">
                            <dt class="col-md-4 text-right">期生</dt>
                            <dd class="col-md-8">◯期生</dd>
                        </dl>
                        <dl class="row mb-4">
                            <dt class="col-md-4 text-right">タイトル</dt>
                            <dd class="col-md-8">あああああああああああああああああああ</dd>
                        </dl>
                        <dl class="row mb-4">
                            <dt class="col-md-4 text-right">URL</dt>
                            <dd class="col-md-8"><a href="https://qiita.com/">https://qiita.com/</a></dd>
                        </dl>
                        <dl class="row mb-4">
                            <dt class="col-md-4 text-right">投稿日時</dt>
                            <dd class="col-md-8">{{ NOW() }}</dd>
