                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="name" autofocus placeholder="やんばる太郎">
                                <span>slack名を入力してください。</span>
                                @error('name')
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-md-6">
                                <input id="term" type="number" class="form-control @error('term') is-invalid @enderror" name="term" value="{{ old('term') }}" autocomplete="term" placeholder="3">
